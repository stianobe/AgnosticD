...
DOCUMENTATION = '''
---
module: gpte_ibm_image_uploader
short_description: upload objects to IBM Cloud Object Store using S3
version_added: "2.7"
description:
    - This module allows the user to upload QCOW2 images from IBM Cloud Storage 
options:
    TODO
...
def check_convert_and_upload_object(module, src, element, dest_disk):
     ...
     try:
         s3.meta.client.head_object(Bucket=bucket_name,Key="%s/%s" % (project, element["dest"]))
...
def run_module():
    ...
    objects = upload_to_ibmcloud(module)
